...
## 7) Análisis de export Uber completo (opcional)
- [ ] Colocar los ficheros `sales-over-time_*.csv`, `sales-leaderboard-items_*.csv`, `sales-hourly_*.csv` y `user-conversion_*.csv` en una carpeta.
- [ ] Cargar y validar con utilidades de `src/load/uber_csv_loader.py`.
